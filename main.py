...
#estimator.train(input_fn=lambda: input_func.train_input_fn(batch_size,num_buckets,numTilings),steps=40000)   
#estimator.evaluate(input_fn=lambda: input_func.eval_input_fn(batch_size,num_buckets,numTilings),steps=100,start_delay_secs=0,throttle_secs=30)   
